...
@Component({
    selector: 'app-provider-list-header',
    templateUrl: 'provider-list-header.component.html',
    styleUrls: ['./provider-list-header.component.scss']
})
export class ProviderListHeaderComponent implements OnInit {
